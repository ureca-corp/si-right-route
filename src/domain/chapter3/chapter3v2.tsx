      ...
      <Stack css={st.bottom}>
        <div css={st.roundCarouselWrapper}>
          <CustomRoundCarousel
            speed={3}
            items={[
              <div css={threeModelsStyle.carSeat}>
                <CarSeat />
              </div>,
              <div css={threeModelsStyle.golfBag}>
                <GolfBAg />
              </div>,
              <div css={threeModelsStyle.menJacket}>
                <MenJacket />
              </div>,
              <div css={threeModelsStyle.purse}>
                <Purse />
              </div>,
              <div css={threeModelsStyle.chair}>
                <Chair />
              </div>,
              <div css={threeModelsStyle.coat}>
                <Coat />
              </div>,
            ]}
          />
